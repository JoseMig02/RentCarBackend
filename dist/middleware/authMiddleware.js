...
exports.isEmployeeOrAdmin = exports.isEmployee = exports.isAdmin = exports.authenticate = exports.validateToken = void 0;
...
const validateToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (headertoken != undefined && headertoken.startsWith('Bearer')) {
        try {
            ...
            const decodedToken = jsonwebtoken_1.default.verify(bearerToken, 'clave_secreta' || 'pepito123');
